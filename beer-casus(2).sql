...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 26 mrt 2024 om 00:04
...
--
-- Tabelstructuur voor tabel `beer_ratings`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `beer_ratings`
--

INSERT INTO `beer_ratings` (`id`, `user_id`, `beer_id`, `rating`, `note`, `created_at`) VALUES
(13, 4, 1, 1, 'lekker', '2024-03-15 09:26:03'),
(14, 4, 2, 3, 'ok', '2024-03-15 10:05:26'),
(15, 5, 1, 2, 'vind t nu kut', '2024-03-15 10:05:37'),
(16, 4, 9, 5, 'uitstekent!', '2024-03-18 08:20:22');
...
INSERT INTO `users` (`id`, `uname`, `email`, `email_verified_at`, `passwords`, `remember_token`, `created_at`, `updated_at`) VALUES
...
--
-- Indexen voor tabel `beer_ratings`
--
...
--
-- AUTO_INCREMENT voor een tabel `beer_ratings`
--
ALTER TABLE `beer_ratings`
...
--
-- Beperkingen voor tabel `beer_ratings`
--
ALTER TABLE `beer_ratings`
  ADD CONSTRAINT `beer_ratings_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `beer_ratings_ibfk_2` FOREIGN KEY (`beer_id`) REFERENCES `beers` (`id`);
